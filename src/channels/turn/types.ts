...
type ChannelCoreManagedDeliveryInfo = Omit<ChannelDeliveryInfo, "bindPendingFinalDelivery"> & {
  /** Call after local preflight and immediately before the first platform delivery request. */
